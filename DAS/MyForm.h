...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// pictureBox1
			// 
			this->pictureBox1->Location = System::Drawing::Point(417, 21);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(9999, 9999);
			...
			this->label6->Location = System::Drawing::Point(26, 361);
...
#pragma endregion
		void ImageWriteToBinaryFile()
		{
			...
			System::IO::FileStream^ binaryStream = System::IO::File::Open("../DAS/rysunek.bin",
			...
			System::IO::FileStream^ imageStream = System::IO::File::OpenRead("../DAS/rysunek.png");
		...
		void ImageReadFromBinaryFile()
		{
			// First open the binary file we want to read binary data.
				System::IO::FileStream^ stream = System::IO::File::Open("../DAS/rysunek.bin",
		...
		label6->Text = "Status";
			 ...
			 void generuj() {
				 ...
				 for (int i = 0; i < total_line; i++) {
					 char alfa[100];
					 sprintf(alfa, "%s", words[2 + i * 5]);
					 x = Convert::ToInt32(words[1 + i * 5]);
					 y = Convert::ToInt32(words[4 + i * 5]);
					 int tmp = alfa[0] - '0';
					 tablica[x, tmp] = y;
